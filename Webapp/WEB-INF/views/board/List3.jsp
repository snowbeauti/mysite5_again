		...
		<div id="content">
			...
			<div id="board">
				<div id="list">
					...
					<form action="board/list3" method="get">
						<table>
							<thead>
								<tr>
									<th>번호</th>
							...
							<c:forEach items="${pMap.boardList}" var="bvo" varStatus="status">
								<tbody>
									<tr>
					...
					<div id="paging">
						<ul>
							...
							<c:forEach begin="${pMap.startPageBtnNo}" end="${pMap.endPageBtnNo}" step="1" var="page">
								<li><a href="${pageContext.request.contextPath}/board/list3?crtPage=${page}&keyword=">${page}</a></li>
							</c:forEach>
